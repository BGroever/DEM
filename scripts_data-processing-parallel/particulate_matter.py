...
conf = SparkConf().setAppName('ParticulateMatter')
...
pmRDD = sc.textFile("Daily_Census_Tract-Level_PM2.5_Concentrations__2011-2014.csv",1)
...
# to get ALL counties
join2011JAN = y2011mJAN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mJAN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011FEB = y2011mFEB.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mFEB, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011MAR = y2011mMAR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mMAR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011APR = y2011mAPR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mAPR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011MAY = y2011mMAY.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mMAY, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011JUN = y2011mJUN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mJUN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011JUL = y2011mJUL.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mJUL, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011AUG = y2011mAUG.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mAUG, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011SEP = y2011mSEP.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mSEP, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011OCT = y2011mOCT.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mOCT, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011NOV = y2011mNOV.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mNOV, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2011DEC = y2011mDEC.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2011mDEC, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012JAN = y2012mJAN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mJAN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012FEB = y2012mFEB.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mFEB, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012MAR = y2012mMAR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mMAR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012APR = y2012mAPR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mAPR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012MAY = y2012mMAY.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mMAY, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012JUN = y2012mJUN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mJUN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012JUL = y2012mJUL.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mJUL, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012AUG = y2012mAUG.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mAUG, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012SEP = y2012mSEP.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mSEP, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012OCT = y2012mOCT.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mOCT, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012NOV = y2012mNOV.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mNOV, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2012DEC = y2012mDEC.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2012mDEC, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013JAN = y2013mJAN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mJAN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013FEB = y2013mFEB.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mFEB, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013MAR = y2013mMAR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mMAR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013APR = y2013mAPR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mAPR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013MAY = y2013mMAY.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mMAY, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013JUN = y2013mJUN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mJUN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013JUL = y2013mJUL.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mJUL, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013AUG = y2013mAUG.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mAUG, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013SEP = y2013mSEP.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mSEP, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013OCT = y2013mOCT.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mOCT, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013NOV = y2013mNOV.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mNOV, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2013DEC = y2013mDEC.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2013mDEC, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014JAN = y2014mJAN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mJAN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014FEB = y2014mFEB.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mFEB, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014MAR = y2014mMAR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mMAR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014APR = y2014mAPR.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mAPR, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014MAY = y2014mMAY.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mMAY, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014JUN = y2014mJUN.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mJUN, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014JUL = y2014mJUL.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mJUL, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014AUG = y2014mAUG.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mAUG, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014SEP = y2014mSEP.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mSEP, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014OCT = y2014mOCT.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mOCT, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014NOV = y2014mNOV.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mNOV, list(x[1])[0])) + ' ' + x[0]))
#-------------------
...
# to get ALL counties
join2014DEC = y2014mDEC.union(allCounties).groupByKey().filter(lambda x: (x[0] != rmCty[0]) and (x[0] != rmCty[1])).map(lambda x: str(str(getMean(mean2014mDEC, list(x[1])[0])) + ' ' + x[0]))
#-------------------
