...
conf = SparkConf().setMaster('local').setAppName('CardiovascularDisease')

sc = SparkContext(conf = conf)

cardRDD = sc.textFile("raw_data/IHME_USA_COUNTY_CVD_MORTALITY_RATES_1980_2014_NATIONAL_Y2017M05D16.txt",1)
